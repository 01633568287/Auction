...
<form action="{{route('auction.update',$auction->id)}}" method="POST" role="form">
    @csrf @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="start_time" name="start_time" value="{{$auction->start_time}}">
                    @error('start_time')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Auction Name" value="{{$auction->name}}">
                    @error('name')
                        <small class="help-block">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="close_time" name="close_time" value="{{$auction->close_time}}">
                    @error('description')
                        <small class="help-block">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="start_price" placeholder="Giá khởi điểm" value="{{$auction->start_price}}">
                    @error('start_price')
                        <small class="help-block">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="step_price" placeholder="Bước giá" value="{{$auction->step_price}}">
                    @error('step_price')
                        <small class="help-block">{{ $message }}</small>
                    @enderror
                </div>
